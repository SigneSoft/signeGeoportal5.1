...
Ext.define('signeGeoportal.store.storeLogin', {
    extend: 'Ext.data.Store',

    requires: [
        'signeGeoportal.model.modelLogin',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            ...
            autoLoad: false,
            autoSync: true,
            model: 'signeGeoportal.model.modelLogin',
            proxy: {
                type: 'ajax',
                api: //{read: '../serverside/getLogin.jsp'}
                {
                    read: 'http://192.168.56.101:8282/serverside/getLogin.jsp'
                },
                url: '',
                reader: {
                    type: 'json',
