/*
 * File: app/store/storeParametro.js
 *
...
Ext.define('signeGeoportal.store.storeParametro', {
    extend: 'Ext.data.Store',

    requires: [
        'signeGeoportal.model.modelParametro',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            ...
            autoLoad: false,
            model: 'signeGeoportal.model.modelParametro',
            proxy: {
                type: 'ajax',
                api: {
